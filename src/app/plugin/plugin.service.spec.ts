...
describe('PluginService', () => {
    ...
    const test_plugin_run = {
        ...
        status: 'scheduled',
        timestamp: '2023-12-01T17:54:58+01:00'
    }
    ...
    it('should get artifacts', () => {
        httpClientSpy.get.withArgs('/api/v1/gateway/store/1fbeed00-e9b7-4f54-bae7-18f64bd33ea6').and
            .returnValue(of([test_correlator, test_artifact]))

        service.getArtifacts('1fbeed00-e9b7-4f54-bae7-18f64bd33ea6').subscribe(artifacts => {
    ...
    it('should store computes', () => {
        expect(localStorage.getItem('plugin_runs')).toBe(null)
        service.storeComputes('1fbeed00-e9b7-4f54-bae7-18f64bd33ea6', test_plugin)
